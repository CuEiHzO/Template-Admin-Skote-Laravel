...
@section('css') 
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('backend/libs/bootstrap-editable/bootstrap-editable.min.css')}}">
@endsection
...
@section('script')
        ...
        <script src="{{ URL::asset('backend/libs/bootstrap-editable/bootstrap-editable.min.js')}}"></script>

        <!-- Init js-->
        <script src="{{ URL::asset('backend/js/pages/form-xeditable.init.js')}}"></script> 
