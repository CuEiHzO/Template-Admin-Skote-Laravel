            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-4 text-right">
                    <a class="btn btn-info btn-sm mt-1" href="{{ route('backend.frontend.promotion.create') }}">
                      <i class="bx bx-plus font-size-16 align-middle mr-1"></i>เพิ่ม Promotion
                    </a>
                  </div>
                </div>
...
$(function() {
    ...
    "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
        ...
        iDisplayLength: 25,
        ajax: {
          url: '{{ route('backend.frontend.promotion.datatable') }}',
          data: function ( d ) {
            d.Where={};
        ...
        columns: [
            ...
            {data: 'meta_keywords_en', title :'<center>Meta Key</center>', className: 'text-left'},
            {data: 'isLink', title :'<center>Url</center>', className: 'text-left'},
        ...
        rowCallback: function(nRow, aData, dataIndex){
          $('td:last-child', nRow).html(''
            + '<a href="{{ route('backend.frontend.promotion.index') }}/'+aData['id']+'/edit" class="btn btn-sm btn-primary"><i class="bx bx-edit font-size-16 align-middle"></i></a> '
            + '<a href="javascript: void(0);" data-url="{{ route('backend.frontend.promotion.index') }}/'+aData['id']+'" class="btn btn-sm btn-danger cDelete"><i class="bx bx-trash font-size-16 align-middle"></i></a>'
          ).addClass('input');
        }
    });
