    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
					<div class="col-8">
						<input type="text" class="form-control float-left text-center w200 myLike" placeholder="Category" name="category.name">
						<input type="text" class="form-control float-left text-center w200 myLike ml-1" placeholder="Name" name="name">
					</div>
					<div class="col-4 text-right">
						<a class="btn btn-info btn-sm mt-1" href="{{ route('backend.product.product.create') }}">
...
<script>
	...
	$(function() {
		oTable = $('#data-table').DataTable({
			...
			iDisplayLength: 25,
			ajax: {
				url: '{{ route('backend.product.product.datatable') }}',
				data: function ( d ) {
					d.Where={};
            ...
            {data: 'category.name', title :'Category', className: 'text-center w100'},
