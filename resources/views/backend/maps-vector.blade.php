...
@section('css') 
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('backend/libs/jquery-vectormap/jquery-vectormap.min.css')}}">
@endsection
...
@section('script')
        ...
        <!-- Plugins js -->
        <script src="{{ URL::asset('backend/libs/jquery-vectormap/jquery-vectormap.min.js')}}"></script>

        <!-- Init js-->
        <script src="{{ URL::asset('backend/js/pages/vector-maps.init.js')}}"></script> 
