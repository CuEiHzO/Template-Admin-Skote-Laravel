...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
              @if( empty($sRow) )
              <form action="{{ route('backend.ecommerce.customer.store') }}" method="POST" autocomplete="off">
              @else
              <form action="{{ route('backend.ecommerce.customer.update', $sRow->id ) }}" method="POST" autocomplete="off">
            ...
            @endif
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" type="text" value="{{ $sRow->firstname??'' }}" name="firstname" required>
                    </div>
                </div>
                ...
                <div class="form-group mb-0 row">
                    <div class="col-md-6">
                        <a class="btn btn-secondary btn-sm waves-effect" href="{{ route('backend.ecommerce.customer.index') }}">
