                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="media">
                                            <img src="backend/images/companies/img-1.png" alt="" class="avatar-sm mr-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered">
                                                <tbody>
                                                    <tr>
                                                        <td style="width: 50px;"><img src="backend/images/users/avatar-2.jpg" class="rounded-circle avatar-xs" alt=""></td>
                                                    ...
                                                    <tr>
                                                        <td><img src="backend/images/users/avatar-1.jpg" class="rounded-circle avatar-xs" alt=""></td>
                                                    ...
                                                    <tr>
                                                        <td><img src="backend/images/users/avatar-4.jpg" class="rounded-circle avatar-xs" alt=""></td>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="media mb-4">
                                            <div class="mr-3">
                                                <img class="media-object rounded-circle avatar-xs" alt="" src="backend/images/users/avatar-2.jpg">
                                            </div>
                                        ...
                                        <div class="media mb-4">
                                            <div class="mr-3">
                                                <img class="media-object rounded-circle avatar-xs" alt="" src="backend/images/users/avatar-3.jpg">
                                            </div>
                                            <div class="media-body">
...
@section('script')
        ...
        <script src="{{ URL::asset('backend/js/pages/project-overview.init.js')}}"></script> 
