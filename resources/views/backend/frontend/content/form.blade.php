...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
              @if( empty($sRow) )
              <form action="{{ route('backend.frontend.content.store',['group'=>$group]) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
              @else
              <form action="{{ route('backend.frontend.content.update',['group'=>$group,'id'=>$sRow->id]  ) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
              ...
              @endif
                ...
                <div class="form-group mb-0 row">
                    <div class="col-md-6">
                        <a class="btn btn-secondary btn-sm waves-effect" href="{{ route('backend.frontend.content.index',['group'=>$group]) }}">
