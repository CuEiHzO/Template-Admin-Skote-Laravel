...
@section('title') Concern List @endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18">Concern List</h4>
            ...
            <div class="card-body">
                <div class="row">
					...
					<div class="col-4 text-right">
						<a class="btn btn-info btn-sm mt-1" href="{{ route('backend.product.concern.create') }}">
...
<script>
	...
	$(function() {
		oTable = $('#data-table').DataTable({
			...
			iDisplayLength: 25,
			ajax: {
				url: '{{ route('backend.product.concern.datatable') }}',
				data: function ( d ) {
					d.Where={};
            ...
            {data: 'category.name', title :'<center>Category</center>', className: 'text-center'},
			...
			rowCallback: function(nRow, aData, dataIndex){
				...
				+ '<a href="{{ route('backend.product.concern.index') }}/'+aData['id']+'/edit" class="btn btn-sm btn-primary"><i class="bx bx-edit font-size-16 align-middle"></i></a> '
				+ '<a href="javascript: void(0);" data-url="{{ route('backend.product.concern.index') }}/'+aData['id']+'" class="btn btn-sm btn-danger cDelete"><i class="bx bx-trash font-size-16 align-middle"></i></a>'
				).addClass('input');
			}
		});
