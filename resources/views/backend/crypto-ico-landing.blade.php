...
<html lang="en">
    ...
    <head>
        ...
        <!-- owl.carousel css -->
        <link rel="stylesheet" href="{{ URL::asset('backend/libs/owl.carousel/owl.carousel.min.css')}}">
    ...
    <body data-spy="scroll" data-target="#topnav-menu" data-offset="60">
        ...
        <nav class="navbar navbar-expand-lg navigation fixed-top sticky">
            <div class="container">
                <a class="navbar-logo" href="backend/template/index.html">
                    <img src="backend/images/logo-dark.png" alt="" height="19" class="logo logo-dark">
                    <img src="backend/images/logo-light.png" alt="" height="19" class="logo logo-light">
                </a>
                        ...
                        <div class="owl-carousel owl-theme clients-carousel" id="clients-carousel">
                            <div class="item">
                                <div class="client-images">
                                    <img src="backend/images/clients/1.png" alt="client-img" class="mx-auto img-fluid d-block">
                                </div>
                            </div>
                            <div class="item">
                                <div class="client-images">
                                    <img src="backend/images/clients/2.png" alt="client-img" class="mx-auto img-fluid d-block">
                                </div>
                            </div>
                            <div class="item">
                                <div class="client-images">
                                    <img src="backend/images/clients/3.png" alt="client-img" class="mx-auto img-fluid d-block">
                                </div>
                            </div>
                            <div class="item">
                                <div class="client-images">
                                    <img src="backend/images/clients/4.png" alt="client-img" class="mx-auto img-fluid d-block">
                                </div>
                            </div>
                            <div class="item">
                                <div class="client-images">
                                    <img src="backend/images/clients/5.png" alt="client-img" class="mx-auto img-fluid d-block">
                                </div>
                            </div>
                            <div class="item">
                                <div class="client-images">
                                    <img src="backend/images/clients/6.png" alt="client-img" class="mx-auto img-fluid d-block">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row align-items-center pt-4">
                    <div class="col-md-6 col-sm-8">
                        <div>
                            <img src="backend/images/crypto/features-img/img-1.png" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                ...
                <div class="row align-items-center mt-5 pt-md-5">
                    ...
                    <div class="col-md-6  col-sm-8 ml-md-auto">
                        <div class="mt-4 mr-md-0">
                            <img src="backend/images/crypto/features-img/img-2.png" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                    ...
                    <div class="owl-carousel owl-theme events navs-carousel" id="team-carousel">
                        <div class="item">
                            <div class="card text-center team-box">
                                <div class="card-body">
                                    <div>
                                        <img src="backend/images/users/avatar-2.jpg" alt="" class="rounded">
                                    </div>
                        ...
                        <div class="item">
                            <div class="card text-center team-box">
                                <div class="card-body">
                                    <div>
                                        <img src="backend/images/users/avatar-3.jpg" alt="" class="rounded">
                                    </div>
                        ...
                        <div class="item">
                            <div class="card text-center team-box">
                                <div class="card-body">
                                    <div>
                                        <img src="backend/images/users/avatar-8.jpg" alt="" class="rounded">
                                    </div>
                                    <div class="mt-3">
                                        <h5>Vickie Sample</h5>
                        ...
                        <div class="item">
                            <div class="card text-center team-box">
                                <div class="card-body">
                                    <div>
                                        <img src="backend/images/users/avatar-5.jpg" alt="" class="rounded">
                                    </div>
                        ...
                        <div class="item">
                            <div class="card text-center team-box">
                                <div class="card-body">
                                    <div>
                                        <img src="backend/images/users/avatar-1.jpg" alt="" class="rounded">
                                    </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-sm-6">
                        <div class="blog-box mb-4 mb-xl-0">
                            <div class="position-relative">
                                <img src="backend/images/crypto/blog/img-1.jpg" alt="" class="rounded img-fluid mx-auto d-block">
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="blog-box mb-4 mb-xl-0">
                            ...
                            <div class="position-relative">
                                <img src="backend/images/crypto/blog/img-2.jpg" alt="" class="rounded img-fluid mx-auto d-block">
                                <div class="badge badge-success blog-badge font-size-11">Cryptocurrency</div>
                            </div>
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="blog-box mb-4 mb-xl-0">
                            <div class="position-relative">
                                <img src="backend/images/crypto/blog/img-3.jpg" alt="" class="rounded img-fluid mx-auto d-block">
                                <div class="badge badge-success blog-badge font-size-11">Cryptocurrency</div>
                            </div>
        ...
        <script src="{{ URL::asset('backend/libs/jquery.easing/jquery.easing.min.js')}}"></script>

        <!-- Plugins js-->
        <script src="{{ URL::asset('backend/libs/jquery-countdown/jquery-countdown.min.js')}}"></script>

        <!-- owl.carousel js -->
        <script src="{{ URL::asset('backend/libs/owl.carousel/owl.carousel.min.js')}}"></script>

        <!-- ICO landing init -->
        <script src="{{ URL::asset('backend/js/pages/ico-landing.init.js')}}"></script>
