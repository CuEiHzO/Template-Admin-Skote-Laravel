...
@section('css') 
        ...
        <!-- Summernote css -->
        <link href="{{ URL::asset('backend/libs/summernote/summernote.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        ...
        <!-- Init js-->
        <script src="{{ URL::asset('backend/js/pages/task-create.init.js')}}"></script> 
