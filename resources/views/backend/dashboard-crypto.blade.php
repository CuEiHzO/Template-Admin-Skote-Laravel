                                    ...
                                    <div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-sm-4 align-self-center">
                                                <div>
                                                    <img src="backend/images/crypto/features-img/img-1.png" alt="" class="img-fluid d-block">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="list-group" data-simplebar style="max-height: 390px;">
                                                ...
                                                <div class="media">
                                                    <div class="avatar-xs mr-3">
                                                        <span class="avatar-title rounded-circle bg-light">
                                                            <img src="backend/images/companies/img-1.png" alt="" height="18">
                                                        </span>
                                                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="media">
                                                    <div class="avatar-xs mr-3">
                                                        <span class="avatar-title rounded-circle bg-light">
                                                            <img src="backend/images/companies/img-2.png" alt="" height="18">
                                                        </span>
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <li class="list-group-item">
                                                <div class="media">
                                                    <div class="avatar-xs mr-3">
                                                        <span class="avatar-title rounded-circle bg-light">
                                                            <img src="backend/images/companies/img-3.png" alt="" height="18">
                                                        </span>
                                                    </div>
                                                    <div class="media-body">
...
@section('script')
        ...
        <!-- crypto dash init js -->
        <script src="{{ URL::asset('backend/js/pages/crypto-dashboard.init.js')}}"></script>
@endsection