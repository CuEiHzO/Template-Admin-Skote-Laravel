...
@section('css')
<link rel="stylesheet" href="{{ URL::asset('backend/libs/cropperjs/cropperjs.min.css')}}">
@endsection
                                        ...
                                        <div class="row">
                                            <div class="col-xl-9">
                                              ...
                                              <div class="img-container mb-2">
                                                <img src="backend/images/small/img-5.jpg" alt="Picture">
                                              </div>
                                            </div>
                                            <div class="col-xl-3">
                                              <!-- <h3>Preview:</h3> -->
...
@section('script')
        <script src="{{ URL::asset('backend/libs/cropperjs/cropperjs.min.js')}}"></script>

        <!-- cropperjs init -->
        <script src="{{ URL::asset('backend/js/pages/cropperjs.init.js')}}"></script>
@endsection