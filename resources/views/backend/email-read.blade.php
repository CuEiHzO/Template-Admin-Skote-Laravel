                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="email-leftbar card">
                                    ...
                                    <div class="mt-2">
                                        <a href="#" class="media">
                                            <img class="d-flex mr-3 rounded-circle" src="backend/images/users/avatar-2.jpg" alt="Generic placeholder image" height="36">
                                        ...
                                        <a href="#" class="media">
                                            <img class="d-flex mr-3 rounded-circle" src="backend/images/users/avatar-3.jpg" alt="Generic placeholder image" height="36">
                                            <div class="media-body chat-user-box">
                                        ...
                                        <a href="#" class="media">
                                            <img class="d-flex mr-3 rounded-circle" src="backend/images/users/avatar-4.jpg" alt="Generic placeholder image" height="36">
                                            <div class="media-body chat-user-box">
                                        ...
                                        <a href="#" class="media">
                                            <img class="d-flex mr-3 rounded-circle" src="backend/images/users/avatar-6.jpg" alt="Generic placeholder image" height="36">
                                            <div class="media-body chat-user-box">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="media mb-4">
                                                <img class="d-flex mr-3 rounded-circle avatar-sm" src="backend/images/users/avatar-2.jpg" alt="Generic placeholder image">
                                            ...
                                            <a href="backend/template/email-compose" class="btn btn-secondary waves-effect mt-4"><i class="mdi mdi-reply"></i> Reply</a>
                                        </div>
...
@section('script')
        ...
        <script src="{{ URL::asset('backend/js/pages/email-summernote.init.js')}}"></script> 
