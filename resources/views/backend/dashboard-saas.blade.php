                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="media">
                                                    <div class="mr-3">
                                                        <img src="backend/images/users/avatar-1.jpg" alt="" class="avatar-md rounded-circle img-thumbnail">
                                                    </div>
...
@section('script')
        ...
        <!-- crypto dash init js -->
        <script src="{{ URL::asset('backend/js/pages/saas-dashboard.init.js')}}"></script>
@endsection