...
@section('css') 
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('backend/libs/ion-rangeslider/ion-rangeslider.min.css')}}">
@endsection
                                ...
                                <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="product-img position-relative">
                                                    ...
                                                    <img src="backend/images/product/img-1.png" alt="" class="img-fluid mx-auto d-block">
                                                </div>
                                    ...
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="product-img position-relative">
                                                    <img src="backend/images/product/img-2.png" alt="" class="img-fluid mx-auto d-block">
                                                </div>
                                                <div class="mt-4 text-center">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="product-img position-relative">
                                                    ...
                                                    <img src="backend/images/product/img-3.png" alt="" class="img-fluid mx-auto d-block">
                                                </div>
                                                <div class="mt-4 text-center">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="product-img position-relative">
                                                    ...
                                                    <img src="backend/images/product/img-5.png" alt="" class="img-fluid mx-auto d-block">
                                                </div>
                                                <div class="mt-4 text-center">
                                                    <h5 class="mb-3 text-truncate"><a href="#" class="text-dark">Half sleeve T-Shirt</a></h5>
...
@section('script')
        ...
        <!-- flot plugins -->
        <script src="{{ URL::asset('backend/libs/ion-rangeslider/ion-rangeslider.min.js')}}"></script>

        <script src="{{ URL::asset('backend/js/pages/product-filter-range.init.js')}}"></script> 
