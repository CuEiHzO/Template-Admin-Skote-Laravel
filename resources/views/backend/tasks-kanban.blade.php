...
@section('css')     
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('backend/libs/dragula/dragula.min.css')}}">
@endsection
                                        ...
                                        <div id="upcoming-task" class="pb-1 task-list">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="team float-left">
                                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                                            <img src="backend/images/users/avatar-4.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                        </a>
    
                                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                                            <img src="backend/images/users/avatar-5.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                        </a>
                                            ...
                                            <div class="card task-box">
                                                <div class="card-body">
                                                    ...
                                                    <div class="team float-left">
                                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                                            <img src="backend/images/users/avatar-6.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                        </a>
    
                                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                                            <img src="backend/images/users/avatar-7.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="text-right">
                                        ...
                                        <div id="inprogress-task" class="pb-1 task-list">
                                            <div class="card task-box">
                                                <div class="card-body">
                                                    ...
                                                    <ul class="list-inine pl-0 mb-4">
                                                            ...
                                                            <a href="#">
                                                                <div class="border rounded avatar-sm">
                                                                    <span class="avatar-title bg-transparent">
                                                                        <img src="backend/images/companies/img-1.png" alt="" class="avatar-xs">
                                                                    </span>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="list-inline-item">
                                                            <a href="#">
                                                                <div class="border rounded avatar-sm">
                                                                    <span class="avatar-title bg-transparent">
                                                                        <img src="backend/images/companies/img-2.png" alt="" class="avatar-xs">
                                                                    </span>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="list-inline-item">
                                                            <a href="#">
                                                                <div class="border rounded avatar-sm">
                                                                    <span class="avatar-title bg-transparent">
                                                                        <img src="backend/images/companies/img-3.png" alt="" class="avatar-xs">
                                                                    </span>
                                                                </div>
                                                            </a>
                                                        </li>
                                                    ...
                                                    <div class="team float-left">
                                                        ...
                                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                                            <img src="backend/images/users/avatar-3.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="card task-box">
                                                <div class="card-body">
                                                    ...
                                                    <div class="team float-left">
                                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                                            <img src="backend/images/users/avatar-8.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                        </a>
                                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                                            <div class="avatar-xs">
                                                                <span class="avatar-title rounded-circle bg-soft-primary text-primary">
                                                        ...
                                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                                            <img src="backend/images/users/avatar-1.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                        </a>
                                            ...
                                            <div class="card task-box">
                                                <div class="card-body">
                                                    ...
                                                    <div class="team float-left">
                                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                                            <img src="backend/images/users/avatar-2.jpg" class="rounded-circle avatar-xs m-1" alt="">
                                                        </a>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <ul class="list-inline mb-4">
                                                        <li class="list-inline-item">
                                                            <a href="#">
                                                                <div>
                                                                    <img src="backend/images/small/img-1.jpg" class="rounded" alt="" height="48">
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="list-inline-item">
                                                            <a href="#">
                                                                <div>
                                                                    <img src="backend/images/small/img-2.jpg" class="rounded" alt="" height="48">
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="list-inline-item">
                                                            <a href="#">
                                                                <div>
                                                                    <img src="backend/images/small/img-3.jpg" class="rounded" alt="" height="48">
                                                                </div>
                                                            </a>
                                                        </li>
                                                    </ul>
...
@section('script')
        ...
        <!-- Plugins js -->
        <script src="{{ URL::asset('backend/libs/dragula/dragula.min.js')}}"></script>

        <!-- Init js-->
        <script src="{{ URL::asset('backend/js/pages/task-kanban.init.js')}}"></script> 
