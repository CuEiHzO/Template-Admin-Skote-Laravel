...
@section('css') 
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('backend/libs/tui-chart/tui-chart.min.css')}}">
@endsection
...
@section('script')
        ...
        <!-- flot plugins -->
        <script src="{{ URL::asset('backend/libs/tui-chart/tui-chart.min.js')}}"></script>

        <script src="{{ URL::asset('backend/js/pages/tui-charts.init.js')}}"></script> 
