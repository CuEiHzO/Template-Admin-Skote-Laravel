...
@section('css') 
<!-- leaflet Css -->
<link href="{{ URL::asset('backend/libs/leaflet/leaflet.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
            ...
            <!-- leaflet map.init -->
            <script src="{{ URL::asset('backend/js/pages/leaflet-us-states.js')}}"></script>

            <!-- leaflet plugin -->
            <script src="{{ URL::asset('backend/libs/leaflet/leaflet.min.js')}}"></script>

@endsection

@section('script-bottom')
            <script src="{{ URL::asset('backend/js/pages/leaflet-map.init.js')}}"></script>
@endsection