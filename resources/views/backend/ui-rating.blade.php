...
@section('css')
        ...
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('backend/libs/bootstrap-rating/bootstrap-rating.min.css')}}">
@endsection
...
@section('script')
        ...
        <!-- Bootstrap rating js -->
        <script src="{{ URL::asset('backend/libs/bootstrap-rating/bootstrap-rating.min.js')}}"></script>

        <!-- Range slider init js -->
        <script src="{{ URL::asset('backend/js/pages/rating-init.js')}}"></script>
