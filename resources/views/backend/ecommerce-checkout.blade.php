...
@section('css')
    <link href="{{('backend/libs/select2/select2.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
                        ...
                        <div class="checkout-tabs">
                                <div class="row">
                                    ...
                                    <div class="col-xl-10 col-sm-9">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-centered mb-0 table-nowrap">
                                                                        ...
                                                                        <tbody>
                                                                        <tr>
                                                                            <th scope="row"><img src="backend/images/product/img-1.png" alt="product-img" title="product-img" class="avatar-md"></th>
                                                                            <td>
                                                                                <h5 class="font-size-14 text-truncate"><a href="backend/template/ecommerce-product-detail" class="text-dark">Half sleeve T-shirt  (64GB) </a></h5>
                                                                                <p class="text-muted mb-0">$ 450 x 1</p>
                                                                            </td>
                                                                            <td>$ 450</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th scope="row"><img src="backend/images/product/img-7.png" alt="product-img" title="product-img" class="avatar-md"></th>
                                                                            <td>
                                                                                <h5 class="font-size-14 text-truncate"><a href="backend/template/ecommerce-product-detail" class="text-dark">Wirless Headphone </a></h5>
                                        ...
                                        <div class="row my-4">
                                            <div class="col-sm-6">
                                                <a href="backend/template/ecommerce-cart" class="btn text-muted d-none d-sm-inline-block btn-link">
...
@section('script')
        ...
        <script src="{{ URL::asset('backend/js/pages/ecommerce-select2.init.js')}}"></script> 
