...
@section('css')
        <link rel="stylesheet" href="{{ URL::asset('backend/libs/twitter-bootstrap-wizard/twitter-bootstrap-wizard.min.css')}}">
...
@section('script')
        ...
        <!-- wizard js -->
        <script src="{{ URL::asset('backend/libs/twitter-bootstrap-wizard/twitter-bootstrap-wizard.min.js')}}"></script>

        <!-- dropzone js -->
        <script src="{{ URL::asset('backend/libs/dropzone/dropzone.min.js')}}"></script>

        <!-- init js -->
        <script src="{{ URL::asset('backend/js/pages/crypto-kyc-app.init.js')}}"></script>
